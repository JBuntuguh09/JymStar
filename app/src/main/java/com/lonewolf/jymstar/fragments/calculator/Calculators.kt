...
import com.lonewolf.jymstar.databinding.FragmentCalculatorsBinding
 ...
 * Use the [Calculators.newInstance] factory method to
...
class Calculators : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentCalculatorsBinding.bind(view)
    ...
    private fun getButtons() {
        binding.cardBMI.setOnClickListener {
            (activity as MainActivity).navTo(BmiCalculator(), "BMI Calculator", storage.currPage!!, 1)
        }
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment Calculators.
         */
