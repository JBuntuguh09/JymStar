...
class Storage(context: Context) {
    ...
    var firetokenId :String?
        get() =pref.getString(FIRETOKENID, "")
        set(TokenId) {
            val editor = editor
            editor.putString(FIRETOKENID, TokenId)
            editor.commit()
        }
    ...
    var selectedPath : String?
        get() = pref.getString(SELECTEDPATH, "")
        set(value) {
            val editor = editor
            editor.putString(SELECTEDPATH, value)
            editor.commit()
        }
    ...
    var selectedId : String?
        get() = pref.getString(SELECTEDID, "")
        set(value) {
            val editor = editor
            editor.putString(SELECTEDID, value)
            editor.commit()
        }
    ...
    var imageId : String?
        get() = pref.getString(IMAGEID, "")
        set(value) {
            val editor = editor
            editor.putString(IMAGEID, value!!)
            editor.commit()
        }

    var imagePath : String?
        get() = pref.getString(IMAGEPATH, "")
        set(value) {
            val editor = editor
    ...
    var firmId : Int
        get() = pref.getInt(FIRMID, 0)
        set(value) {
            val editor = editor
            editor.putInt(FIRMID, value)
            editor.commit()
        }
...
//    }
    ...
    companion object {
        ...
        //New
        private const val STAFFID = "Staff Id"
        private const val CLIENTID = "Client id"
        private const val ROLEID = "Role Id"
        private const val FIRMID = "Firm Id"
        private const val PERSONID = "Person ID"
        private const val FULLNAME = "User full name"
        private const val IMAGEID = "User image Id"
        private const val IMAGEPATH = "User image path"
         private const val SELECTEDPATH = "selected pic path"
        private const val FIRETOKENID = "fire token id"
        private const val SELECTEDID = "selected Id"
