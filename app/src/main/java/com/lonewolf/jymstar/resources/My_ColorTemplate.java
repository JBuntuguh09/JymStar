...
public class My_ColorTemplate {
    ...
    public static final int[] PIECOLORS = {
             Color.rgb(255, 240, 240), Color.rgb(118, 22, 28),Color.rgb(163, 67, 73)
    };

    public static final int[] PIECOLORSTEXT = {
            Color.rgb(0, 0, 0), Color.rgb(255, 255, 255), Color.rgb(163, 67, 73)
    };
